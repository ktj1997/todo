...
import com.example.myproject.exception.InvalidUserInfoException;
import com.example.myproject.exception.UserAlreadyExistException;
...
public class AuthService {
    ...
    public void signUp(SignUpRequestDto signUpRequestDto) {
        ...
        userRepository.save(User.builder()
                ...
                .roles(Collections.singletonList(UserAuthority.ROLE_USER.toString())) //Collections.singletonList는 불변성을 보장하고, 메모리에서 이점을 가질 수 있다.
